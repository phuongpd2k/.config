...
vim.api.nvim_create_autocmd("BufEnter", {
  pattern = "*.md", -- Or whichever file type you want
  callback = function()
    vim.keymap.set("n", "gj", [[/^##\+ .*<CR>]], { buffer = true, silent = true, desc = "Jump to next header" })
    vim.keymap.set("n", "gk", [[?^##\+ .*<CR>]], { buffer = true, silent = true, desc = "Jump to previous header" })
  end,
})
-- vim.keymap.set("n", "gj", "/^##\\+ .*<CR>", { desc = "Jump to next header" })
-- vim.keymap.set("n", "gk", "?^##\\+ .*<CR>", { desc = "Jump to previous header" })
...
vim.keymap.set("n", "y", '"+y', { desc = 'Yank into " register' })
vim.keymap.set("v", "y", '"+y', { desc = 'Yank into " register' })
vim.keymap.set("n", "Y", '"+Y', { desc = 'Yank into " register' })
vim.keymap.set("v", "Y", '"+Y', { desc = 'Yank into " register' })

-- Delete text to " register
vim.keymap.set("n", "d", '"+d', { desc = 'Delete and Yank into " register' })
vim.keymap.set("v", "d", '"+d', { desc = 'Delete and Yank into " register' })
vim.keymap.set("n", "D", '"+D', { desc = 'Delete and Yank into " register' })
vim.keymap.set("v", "D", '"+D', { desc = 'Detele and Yank into " register' })

vim.keymap.set("n", "x", '"_x', { desc = 'Delete into " register' })
vim.keymap.set("v", "x", '"_x', { desc = 'Delete into " register' })
vim.keymap.set("n", "X", '"_X', { desc = 'Delete into " register' })
vim.keymap.set("v", "X", '"_X', { desc = 'Delete into " register' })

-- Paste text without yanking
vim.keymap.set("n", "P", '"+P', { desc = 'Paste into " register' })
vim.keymap.set("v", "P", '"+P', { desc = 'Paste into " register' })
vim.keymap.set("n", "p", '"+p', { desc = 'Paste into " register' })
vim.keymap.set("v", "p", '"+p', { desc = 'Paste into " register' })
...
-- Quick close
vim.keymap.set("n", "<leader>Q", "<cmd>qa!<CR>", { desc = "Close Buffer" })
-- close buffer
...
vim.keymap.set(
  "n",
  "<leader>of",
  ':Telescope find_files search_dirs={"/Users/phuongpd/library/Mobile\\ Documents/iCloud~md~obsidian/Documents/DigitalBrains/notes"}<cr>'
)
vim.keymap.set(
  "n",
  "<leader>og",
  ':Telescope live_grep search_dirs={"/Users/phuongpd/library/Mobile\\ Documents/iCloud~md~obsidian/Documents/DigitalBrans/notes"}<cr>'
)
...
-- Quick scroll
vim.keymap.set("n", "J", "5jzz", { desc = "Down 5 lines middle forcus" })
vim.keymap.set("n", "K", "5kzz", { desc = "Up 5 lines middle forcus" })
vim.keymap.set("v", "J", "5jzz", { desc = "Down 5 lines middle forcus" })
vim.keymap.set("v", "K", "5kzz", { desc = "Up 5 lines middle forcus" })
vim.keymap.set("n", "j", "jzz", { desc = "Down middle focus" })
vim.keymap.set("n", "k", "kzz", { desc = "Up middle forcus" })
